...
async function main() {
  ...
  // Seed Users (linked to employees) - HASH PASSWORDS with bcrypt
  ...
  await prisma.user.createMany({
    data: [
      { email: 'admin@example.com', password: adminPassword, role: UserRole.ADMIN, employeeId: createdEmployees['EMP000001'].id },
      { email: 'manager@example.com', password: managerPassword, role: UserRole.MANAGER, employeeId: createdEmployees['EMP000002'].id },
      { email: 'staff@example.com', password: staffPassword, role: UserRole.STAFF, employeeId: createdEmployees['EMP000003'].id },
    ],
  })
