          ...
          <Table className="relative w-full" style={{ minWidth: '100%' }}>
                  ...
                  <div className="flex items-center gap-3 px-4">
                    {onBulkDelete && showBulkDeleteButton && (
                      <Button
                          variant="outline"
                          size="sm"
                          className="h-8 border-destructive text-destructive hover:bg-destructive/5 hover:text-destructive"
            ...
            <TableRow className="h-12">
              {displayColumns.map((column, colIndex) => {
                  ...
                  if (['control', 'select', 'expander'].includes(column.id)) {
                      thClassName = cn(thClassName, "px-2");
                  }
                    ...
                    >
                      {displayColumns.map((column, colIndex) => {
                        ...
                        if (stickyMeta === 'left') {
                         ...
                         if (['control', 'select', 'expander'].includes(column.id)) {
                            tdClassName = cn(tdClassName, "px-2");
                        }
