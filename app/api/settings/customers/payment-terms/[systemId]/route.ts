...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch payment term' }, { status: 500 });
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to update payment term' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete payment term' }, { status: 500 });
  }
}
