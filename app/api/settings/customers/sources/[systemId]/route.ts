...
export async function GET(
  ...
  try {
    ...
    console.error('[Customer Sources API] GET by ID error:', error);
    return NextResponse.json({ error: 'Failed to fetch customer source' }, { status: 500 });
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[Customer Sources API] PATCH error:', error);
    return NextResponse.json({ error: 'Failed to update customer source' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[Customer Sources API] DELETE error:', error);
    return NextResponse.json({ error: 'Failed to delete customer source' }, { status: 500 });
  }
}
