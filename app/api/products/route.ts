  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        images: body.galleryImages || body.images || [],
        ...
        warrantyMonths: body.warrantyPeriodMonths ?? 12,
        supplier: body.primarySupplierId ? { connect: { systemId: body.primarySupplierId } } : undefined,
