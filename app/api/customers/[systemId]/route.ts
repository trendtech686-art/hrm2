  ...
  try {
    ...
    const customer = await prisma.customer.update({
      ...
      data: {
        ...
        contactPerson: body.representative || body.contactPerson,
        address: body.addresses?.[0]?.fullAddress || body.address,
        currentDebt: body.currentDebt,
        creditLimit: body.maxDebt || body.creditLimit,
        customerType: body.lifecycleStage || body.customerType,
        notes: body.notes,
