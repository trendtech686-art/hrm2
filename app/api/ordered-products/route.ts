...
import { parsePagination, apiPaginated, apiError } from '@/lib/api-utils'
...
export const GET = apiHandler(async (request) => {
  try {
    ...
    logError('GET /api/ordered-products failed', error)
    return apiError('Failed to fetch ordered products', 500)
  }
