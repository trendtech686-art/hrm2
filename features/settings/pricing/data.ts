...
export const data: PricingPolicy[] = [
  ...
  {
    systemId: asSystemId('PP000005'),
    id: asBusinessId('SHOPEE'),
    name: 'shopee',
  ...
  {
    systemId: asSystemId('PP000006'),
    id: asBusinessId('TIKTOK'),
    name: 'tiktok',
  ...
  {
    systemId: asSystemId('PP000008'),
    id: asBusinessId('IDWEB'),
    name: 'idweb',
