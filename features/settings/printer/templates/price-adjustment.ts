/**
 * Mẫu in Phiếu điều chỉnh giá bán - TipTap compatible
 * Cập nhật: Thiết kế đen trắng cho máy in
 */
export const PRICE_ADJUSTMENT_TEMPLATE = `
...
<!-- TIÊU ĐỀ -->
<h2 style="text-align: center; margin: 15px 0 5px 0; font-size: 16px; font-weight: bold; border-bottom: 2px solid #333; padding-bottom: 10px;">PHIẾU ĐIỀU CHỈNH GIÁ BÁN</h2>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; table-layout: fixed;">
  <tbody>
    <tr>
      <td style="padding: 5px; width: 25%; background: #f5f5f5; border: 1px solid #333;">Bảng giá:</td>
      <td style="padding: 5px; border: 1px solid #333;"><strong>{pricing_policy}</strong></td>
    </tr>
    <tr>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; font-size: 11px;">
  <thead>
    <tr style="background: #f5f5f5;">
      ...
      <th style="padding: 6px; border: 1px solid #333; text-align: right;">Giá cũ</th>
      <th style="padding: 6px; border: 1px solid #333; text-align: right;">Giá mới</th>
  ...
  <tbody>
    <tr data-line-item>
      ...
      <td style="padding: 5px; border: 1px solid #333; font-family: monospace;">{line_product_code}</td>
...
<table style="width: 50%; margin-left: auto; border-collapse: collapse; margin-bottom: 15px;">
  <tbody>
    ...
    <tr>
      <td style="padding: 5px; background: #f5f5f5; border: 1px solid #333;">Tổng giá cũ:</td>
      <td style="padding: 5px; border: 1px solid #333; text-align: right;">{total_old_value}</td>
    </tr>
    <tr>
      <td style="padding: 5px; background: #f5f5f5; border: 1px solid #333;">Tổng giá mới:</td>
      <td style="padding: 5px; border: 1px solid #333; text-align: right;">{total_new_value}</td>
    </tr>
