...
interface Props { data: CustomerGroup[]; onEdit: (item: BaseSetting) => void; onDelete: (item: BaseSetting) => void; onToggleActive: (item: BaseSetting, value: boolean) => void; onToggleDefault: (item: BaseSetting & { isDefault?: boolean }, value: boolean) => void; }

export function GroupsTab({ data, onEdit, onDelete, onToggleActive, onToggleDefault }: Props) {
  return (
