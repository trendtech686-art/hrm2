  ...
  return (
    <div className="grid grid-cols-3 items-center gap-2 group/item">
      ...
      <dd className="col-span-2 text-sm font-medium flex items-center justify-between">
        ...
        {value && (
          <Button variant="ghost" size="icon" className="h-11 w-11 md:opacity-0 md:group-hover/item:opacity-100 transition-opacity" aria-label="Sao chép" onClick={handleCopy}>
