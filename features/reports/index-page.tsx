...
const reportGroups: ReportGroup[] = [
  {
    ...
    reports: [
      ...
      { 
        title: 'Theo nguồn đơn', 
        description: 'Doanh thu theo nguồn đơn hàng', 
        href: ROUTES.REPORTS.SALES_BY_SOURCE,
        icon: Globe,
      },
      { 
        title: 'Theo nhóm khách', 
        description: 'Doanh thu theo nhóm khách hàng', 
        href: ROUTES.REPORTS.SALES_BY_CUSTOMER_GROUP,
        icon: UsersRound,
      },
      { 
        title: 'Theo thuế', 
        description: 'Phân tích doanh thu theo mức thuế suất', 
        href: ROUTES.REPORTS.SALES_BY_TAX,
        icon: Receipt,
      },
    ],
  },
  {
    ...
    reports: [
      ...
      { 
        ...
        description: 'Danh sách chi tiết các vận đơn', 
        href: ROUTES.REPORTS.DELIVERY_BY_SHIPMENT,
        icon: FileText,
      },
      { 
      ...
      { 
        title: 'Theo khách hàng', 
        description: 'Giao hàng theo từng khách hàng', 
        href: ROUTES.REPORTS.DELIVERY_BY_CUSTOMER,
        icon: Users,
      },
      { 
        title: 'Theo kênh bán hàng', 
        description: 'Giao hàng theo kênh bán hàng', 
        href: ROUTES.REPORTS.DELIVERY_BY_CHANNEL,
        icon: Radio,
      },
      { 
        title: 'Theo nguồn bán hàng', 
        description: 'Giao hàng theo nguồn đơn hàng', 
        href: ROUTES.REPORTS.DELIVERY_BY_SOURCE,
        icon: Globe,
      },
    ],
  },
