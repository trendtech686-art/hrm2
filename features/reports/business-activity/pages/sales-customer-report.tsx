...
import { useSalesCustomerReport } from '../hooks/index.ts';
import { ResponsiveDataTable } from '@/components/data-table/responsive-data-table.tsx';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card.tsx';
import { Badge } from '@/components/ui/badge.tsx';
import { Button } from '@/components/ui/button.tsx';
import type { ColumnDef } from '@/components/data-table/types.ts';
import type { ReportDateRange, SalesCustomerReportRow, ChartType } from '../types.ts';
...
export function SalesCustomerReportPage() {
  ...
  const tableData = React.useMemo(() => {
    const summaryRow: SalesCustomerReportRow & { systemId: string; _isSummary: boolean } = {
      customerSystemId: '__summary__' as any,
      customerName: 'Tổng',
      customerCode: '',
      customerGroup: '',
    ...
    return [summaryRow, ...data.map(row => ({
      ...row,
      systemId: row.customerSystemId as string,
      _isSummary: false,
    }))];
  }, [data, summary]);
