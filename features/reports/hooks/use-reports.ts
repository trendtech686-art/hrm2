...
export function useSalesReport(filters: ReportFilters = {}) {
  return useQuery({
    ...
    queryFn: () => api.fetchSalesReport(filters),
    staleTime: 1000 * 60 * 5,
...
export function useInventoryReport(filters: ReportFilters = {}) {
  return useQuery({
    ...
    queryFn: () => api.fetchInventoryReport(filters),
    staleTime: 1000 * 60 * 5,
    placeholderData: keepPreviousData,
  });
}
...
export function useCustomerSlaReport(filters: ReportFilters = {}) {
  return useQuery({
    queryKey: reportKeys.customerSla(filters),
    queryFn: () => api.fetchCustomerSlaReport(filters),
    staleTime: 1000 * 60 * 5,
    placeholderData: keepPreviousData,
  });
}
...
export function useProductSlaReport(filters: ReportFilters = {}) {
  return useQuery({
    queryKey: reportKeys.productSla(filters),
    queryFn: () => api.fetchProductSlaReport(filters),
    staleTime: 1000 * 60 * 5,
    placeholderData: keepPreviousData,
  });
}
...
export function useBusinessActivityReport(filters: ReportFilters = {}) {
  return useQuery({
    queryKey: reportKeys.businessActivity(filters),
    queryFn: () => api.fetchBusinessActivityReport(filters),
    staleTime: 1000 * 60 * 5,
    placeholderData: keepPreviousData,
  });
}
