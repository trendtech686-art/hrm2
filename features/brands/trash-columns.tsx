  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="max-w-62.5">
        ...
        {row.description && (
          <div className="text-body-xs text-muted-foreground truncate" title={row.description}>
            {row.description}
          </div>
        )}
      </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    onRestore(brand.systemId as SystemId);
                  }}
                >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    onPermanentDelete(brand.systemId as SystemId);
                  }}
                >
