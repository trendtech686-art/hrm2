...
import type { ComplaintType, ComplaintResolution } from "./types.ts";
...
export function ComplaintStatisticsPage() {
  ...
  // ✅ Manual breadcrumb để đảm bảo hiển thị đúng
  const actions = React.useMemo(() => [
    <Button key="back" variant="outline" onClick={() => navigate("/complaints")}>
  ...
  usePageHeader({ 
    ...
    breadcrumb: [
      ...
      { label: 'Khiếu nại', href: '/complaints', isCurrent: false },
      { label: 'Thống kê khiếu nại', href: '', isCurrent: true }
    ] as any
  });
