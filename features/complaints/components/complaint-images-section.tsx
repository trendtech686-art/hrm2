      ...
      <div className="grid grid-cols-5 gap-2">
        {images.map((img, idx) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/50 transition-all rounded flex items-center justify-center md:opacity-0 md:group-hover:opacity-100">
