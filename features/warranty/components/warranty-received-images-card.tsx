...
interface WarrantyReceivedImagesCardProps {
...
/**
 * Card hiển thị hình ảnh lúc nhận hàng
 * Bao gồm cả ExistingDocumentsViewer và NewDocumentsUpload
 */
export function WarrantyReceivedImagesCard({
  isEditing,
  disabled = false,
  permanentFiles,
  setPermanentFiles,
  ...
  filesToDelete,
  onMarkForDeletion,
}: WarrantyReceivedImagesCardProps) {
  return (
    <Card>
