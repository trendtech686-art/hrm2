  ...
  const handleCancel = React.useCallback(async () => {
    ...
    try {
      ...
      update(ticket.systemId, {
        ...
        cancelReason: cancelReason, // Save cancel reason to ticket
        linkedOrderSystemId: undefined, // ✅ Remove link to order when cancelling
        stockDeducted: false, // ✅ Reset flag to prevent duplicate rollback
