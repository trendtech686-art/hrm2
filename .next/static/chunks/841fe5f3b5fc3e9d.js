(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,107038,t=>{"use strict";var d=t.i(768834),e=t.i(579473);let i=`
...
`,penalty:i,leave:i,"cost-adjustment":`
<div style="font-family: Arial, sans-serif; font-size: 12px; line-height: 1.4; max-width: 800px; margin: 0 auto; padding: 10px;">
...
`};function r(t){return t in o?o[t]:t in n?n[t]:""}let p=(t,d,e)=>e?`${t}-${d}-${e}`:`${t}-${d}`,l=(0,d.create)()((0,e.persist)((t,d)=>({templates:{},defaultSizes:{},getTemplate:(t,e,i)=>{let o=d(),n=p(t,e,i),l=o.templates[n];if(l&&l.content&&""!==l.content.trim())return("payroll"===t||"payslip"===t)&&(l.content.includes("{{#line_items}}")||l.content.includes("{line_index}"))?{id:`template-${n}`,type:t,name:"payroll"===t?"Bảng lương":"Phiếu lương",content:r(t),paperSize:e,isActive:!0,updatedAt:new Date().toISOString()}:l;let x=p(t,e),a=o.templates[x];return i&&a&&a.content&&""!==a.content.trim()?("payroll"===t||"payslip"===t)&&(a.content.includes("{{#line_items}}")||a.content.includes("{line_index}"))?{id:`template-${n}`,type:t,name:"payroll"===t?"Bảng lương":"Phiếu lương",content:r(t),paperSize:e,isActive:!0,updatedAt:new Date().toISOString()}:a:{id:`template-${n}`,type:t,name:"order"===t?"Mẫu hóa đơn bán hàng":"Mẫu in",content:r(t),paperSize:e,isActive:!0,updatedAt:new Date().toISOString()}},updateTemplate:(d,e,i,o)=>{let n=p(d,e,o);t(t=>{let o=t.templates[n]||{id:`template-${n}`,type:d,name:"Mẫu in",content:r(d),paperSize:e,isActive:!0,updatedAt:new Date().toISOString()};return{templates:{...t.templates,[n]:{...o,content:i,updatedAt:new Date().toISOString()}}}})},updateTemplateAllBranches:(d,e,i)=>{let o=p(d,e);t(t=>{let n={...t.templates};return Object.keys(n).forEach(t=>{t.startsWith(`${d}-${e}-`)&&delete n[t]}),{templates:{...n,[o]:{id:`template-${o}`,type:d,name:"Mẫu in",content:i,paperSize:e,isActive:!0,updatedAt:new Date().toISOString()}}}})},resetTemplate:(d,e,i)=>{let o=p(d,e,i);t(t=>({templates:{...t.templates,[o]:{id:`template-${o}`,type:d,name:"Mẫu mặc định",content:r(d),paperSize:e,isActive:!0,updatedAt:new Date().toISOString()}}}))},setDefaultSize:(d,e)=>{t(t=>({defaultSizes:{...t.defaultSizes,[d]:e}}))},getDefaultSize:t=>d().defaultSizes[t]||"A4"}),{name:"print-templates-storage"}));t.s(["usePrintTemplateStore",0,l],107038)}]);