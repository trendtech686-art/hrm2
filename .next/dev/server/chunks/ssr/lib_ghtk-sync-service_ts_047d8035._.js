module.exports = [
"[project]/lib/ghtk-sync-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class GHTKSyncService {
   ...
   */ async checkWebhookUpdates() {
        try {
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiUrl"])('/shipping/ghtk/webhook/poll'));
   ...
   */ async processWebhookUpdate(update) {
        try {
            ...
            const { useOrderStore } = await __turbopack_context__.A("[project]/features/orders/store.ts [app-ssr] (ecmascript, async loader)");
   ...
   */ shouldSync(packaging) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ghtk$2d$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shouldSyncGHTKStatus"])(packaging.ghtkStatusId)) {
            return false;
        }
   ...
   */ async syncOne(orderSystemId, packagingSystemId, trackingCode) {
        ...
        try {
            ...
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiUrl"])(`/shipping/ghtk/track/${trackingCode}`));
            const data = await response.json();
            if (!response.ok) {
...
//# sourceMappingURL=lib_ghtk-sync-service_ts_047d8035._.js.map