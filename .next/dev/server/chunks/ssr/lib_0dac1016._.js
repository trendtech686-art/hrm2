...
"[project]/lib/import-export/configs/stock-transfer.config.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    "flattenStockTransfersForExport",
    ()=>flattenStockTransfersForExport,
    "stockTransferFields",
    ()=>stockTransferFields,
    "stockTransferImportExportConfig",
    ()=>stockTransferImportExportConfig
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$products$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/products/store.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$branches$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/branches/store.ts [app-ssr] (ecmascript)");
...
const stockTransferImportExportConfig = {
    entityType: 'stock-transfers',
    ...
    validateRow: (row, _index, existingData, mode)=>{
        ...
        if (!importRow.fromBranchIdOrName) {
            errors.push({
                field: 'fromBranchIdOrName',
                message: 'Kho chuyển không được để trống'
            });
        }
        if (!importRow.toBranchIdOrName) {
            errors.push({
                field: 'toBranchIdOrName',
                message: 'Kho nhận không được để trống'
            });
        }
        ...
        if (importRow.fromBranchIdOrName && importRow.toBranchIdOrName) {
            if (importRow.fromBranchIdOrName.toLowerCase() === importRow.toBranchIdOrName.toLowerCase()) {
                errors.push({
                    field: 'toBranchIdOrName',
                    message: 'Kho nhận phải khác kho chuyển'
                });
            }
        }
        // Check duplicate
        if (mode === 'insert-only' && importRow.transferId) {
            const duplicate = existingData.find((t)=>t.id.toUpperCase() === importRow.transferId.toUpperCase());
            if (duplicate) {
        ...
        for (const [transferId, rows] of transferMap.entries()){
            ...
            for (const row of rows){
                ...
                items.push({
                    ...
                    productId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asBusinessId"])(product?.id || row.productIdOrSku || ''),
            ...
            const transfer = {
                systemId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])(''),
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asBusinessId"])(transferId),
...
function flattenStockTransfersForExport(transfers) {
    const rows = [];
...
"[project]/lib/print/stock-transfer-print-helper.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
function convertStockTransferForPrint(transfer, options = {}) {
...
//# sourceMappingURL=lib_0dac1016._.js.map