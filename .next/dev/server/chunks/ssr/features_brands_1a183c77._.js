...
function BrandsPage() {
    ...
    const [columnVisibility, setColumnVisibility] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$column$2d$visibility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useColumnVisibility"])('brands', {});
    // Column order and pinned columns - synced to database
    const [columnOrder, setColumnOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$column$2d$visibility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useColumnOrder"])('brands', []);
    const [pinnedColumns, setPinnedColumns] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$column$2d$visibility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePinnedColumns"])('brands', [
        'select',
        'logo',
        'name'
    ]);
    ...
    // PKGX Sync Hook
    const { handleSyncBasicInfo, handleSyncSeo, handleSyncDescription, handleSyncAll, hasPkgxMapping, getPkgxBrandId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$brands$2f$hooks$2f$use$2d$pkgx$2d$brand$2d$sync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePkgxBrandSync"])();
    ...
    const { confirmAction: bulkConfirmAction, progress: bulkProgress, triggerBulkSync, executeAction: executeBulkAction, cancelConfirm: cancelBulkConfirm, getPkgxBrandId: hookGetPkgxBrandId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$hooks$2f$use$2d$pkgx$2d$bulk$2d$sync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePkgxBulkSync"])({
        entityType: 'brand'
    });
    ...
    const columns = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$brands$2f$columns$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getColumns"])(handleDelete, handleToggleActive, (path)=>router.push(path), handleUpdateName, // PKGX handlers - used by PkgxBrandActionsCell
...
//# sourceMappingURL=features_brands_1a183c77._.js.map