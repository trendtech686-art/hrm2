...
const pricingPolicySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Mã không được để trống').max(20, 'Mã không được quá 20 ký tự').regex(/^[A-Z0-9]+$/, 'Mã chỉ được chứa chữ in hoa và số'),
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Tên không được để trống').max(100, 'Tên không được quá 100 ký tự'),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500, 'Mô tả không được quá 500 ký tự').optional(),
    ...
    const handleToggleDefault = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((policy, checked)=>{
        if (checked) {
            ...
            if (samePolicies.length > 0) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].error('Phải có ít nhất một chính sách giá mặc định');
            }
        }
    }, [
        allData,
...
function PricingPolicyContent({ isActive, onRegisterActions }) {
    ...
    const confirmDelete = ()=>{
        if (idToDelete) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã xóa chính sách giá "${policy?.name}"`);
        }
    ...
    const handleFormSubmit = (values)=>{
        ...
        if (editingPolicy) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã cập nhật chính sách giá "${normalized.name}"`);
        } else {
            create.mutate(normalized);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã thêm chính sách giá "${normalized.name}"`);
        }
        setIsFormOpen(false);
    };
    const handleSetDefault = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((systemId)=>{
        ...
        if (policy) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã đặt "${policy.name}" làm giá mặc định`);
        }
    }, [
        data,
        setDefault
    ...
    const handleToggleActive = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((policy, isActive)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(isActive ? `Đã kích hoạt "${policy.name}"` : `Đã tắt "${policy.name}"`);
    }, [
        update
    ]);
    const sellingPoliciesForTab = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMemo"](()=>data.filter((p)=>p.type === 'Bán hàng'), [
        data
    ]);
    const purchasingPoliciesForTab = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMemo"](()=>data.filter((p)=>p.type === 'Nhập hàng'), [
        data
    ]);
    ...
    const handleToggleDefaultSale = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((tax, checked)=>{
        if (checked) {
            ...
            if (otherTaxes.length > 0) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].error('Phải có ít nhất một thuế mặc định bán hàng');
            }
        }
    }, [
        allData,
    ...
    const handleToggleDefaultPurchase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((tax, checked)=>{
        if (checked) {
            ...
            if (otherTaxes.length > 0) {
                ...
                // No other tax, cannot turn off
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].error('Phải có ít nhất một thuế mặc định nhập hàng');
            }
        }
    }, [
        allData,
...
function TaxContent({ isActive, onRegisterActions }) {
    ...
    const confirmDelete = ()=>{
        if (idToDelete) {
            ...
            remove(idToDelete);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã xóa thuế "${tax?.name}"`);
        }
        setIsAlertOpen(false);
        setIsFormOpen(false);
        setIdToDelete(null);
    ...
    const handleFormSubmit = (values)=>{
        if (editingTax) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã cập nhật thuế "${values.name}"`);
        } else {
            add({
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["asBusinessId"])(values.id.trim().toUpperCase()),
                name: values.name.trim(),
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã thêm thuế "${values.name}"`);
        }
        setIsFormOpen(false);
    };
    const handleSetDefaultSale = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((systemId)=>{
        ...
        if (tax) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã đặt "${tax.name}" làm thuế mặc định bán hàng`);
        }
    }, [
        data,
        setDefaultSale
    ...
    const handleSetDefaultPurchase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCallback"]((systemId)=>{
        ...
        if (tax) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toast"].success(`Đã đặt "${tax.name}" làm thuế mặc định nhập hàng`);
        }
    }, [
        data,
        setDefaultPurchase
