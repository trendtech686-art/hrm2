...
"[project]/lib/import-export/configs/order-sapo.config.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getCustomerStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCustomerStore"].getState();
const getProductStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$products$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductStore"].getState();
const getBranchStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$branches$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBranchStore"].getState();
const getEmployeeStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$employees$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEmployeeStore"].getState();
// Lookup customer by id or name
const findCustomer = (identifier)=>{
...
const sapoOrderImportConfig = {
    ...
    validateRow: (row, _index, existingData, mode)=>{
        ...
        if (!importRow.productId && !importRow.productName) {
            errors.push({
                field: 'productId',
                message: 'Mã hàng hoặc tên hàng không được để trống'
            });
        }
        // Số lượng phải > 0
        ...
        if (mode === 'insert-only' && importRow.orderId) {
            ...
            if (duplicate) {
                errors.push({
                    field: 'orderId',
                    message: `[Warning] Mã đơn hàng "${importRow.orderId}" đã tồn tại - sẽ bỏ qua`
                });
            }
        }
        return errors;
    ...
    beforeImport: async (data)=>{
        ...
        for (const [orderId, rows] of orderMap.entries()){
            ...
            for (const row of rows){
                ...
                lineItems.push({
                    productSystemId: product?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])(''),
                    productId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asBusinessId"])(product?.id || row.productId || ''),
            ...
            const shippingAddress = firstRow.shippingStreet ? {
            ...
            let deliveryStatus = 'Chờ đóng gói';
            ...
            const order = {
                ...
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asBusinessId"])(orderId),
                // Customer info
                customerSystemId: customer?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])(''),
                ...
                salespersonSystemId: salesperson?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])(''),
                // Dates
                ...
                createdBy: salesperson?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])('SYSTEM'),
                updatedAt: now,
                updatedBy: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asSystemId"])('SYSTEM'),
                // Line items
                lineItems,
                // Totals
                subtotal,
                ...
                returnStatus,
                // Shipping
                deliveryMethod: firstRow.carrier ? 'Dịch vụ giao hàng' : 'Nhận tại cửa hàng',
                shippingAddress,
                // Other
...
"[project]/features/orders/components/order-import-export-dialogs.tsx [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
function OrderImportDialog({ open, onOpenChange, existingData, onImport, currentUser, storeContext }) {
    const configWithStores = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$import$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GenericImportDialogV2"], {
        ...
        fileName: "[project]/features/orders/components/order-import-export-dialogs.tsx",
        lineNumber: 59,
        columnNumber: 5
    }, this);
}
function OrderExportDialog({ open, onOpenChange, allData, filteredData, currentPageData, selectedData, currentUser }) {
...
function SapoOrderImportDialog({ open, onOpenChange, existingData, onImport, currentUser, storeContext }) {
    const configWithStores = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>({
...
"[project]/features/orders/components/order-import-export-dialogs.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "OrderExportDialog",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$components$2f$order$2d$import$2d$export$2d$dialogs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["OrderExportDialog"],
    "OrderImportDialog",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$components$2f$order$2d$import$2d$export$2d$dialogs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["OrderImportDialog"],
    "SapoOrderImportDialog",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$components$2f$order$2d$import$2d$export$2d$dialogs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SapoOrderImportDialog"],
    "flattenOrdersForExport",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$order$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flattenOrdersForExport"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$components$2f$order$2d$import$2d$export$2d$dialogs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/features/orders/components/order-import-export-dialogs.tsx [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$order$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/import-export/configs/order.config.ts [app-ssr] (ecmascript)");
}),
];

//# sourceMappingURL=_68c21e20._.js.map