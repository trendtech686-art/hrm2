...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/features_settings_shipping_integrations_ghtk-service_ts_59e40d33._.js"
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/lib_utils_3807904b._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/lib/utils/get-shipping-credentials.ts [app-ssr] (ecmascript)");
    });
});
}),
"[project]/features/warranty/store/stock-management.ts [app-ssr] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.resolve().then(() => {
        return parentImport("[project]/features/warranty/store/stock-management.ts [app-ssr] (ecmascript)");
    });
});
}),
];