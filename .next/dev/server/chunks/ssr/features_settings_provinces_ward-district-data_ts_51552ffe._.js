module.exports = [
"[project]/features/settings/provinces/ward-district-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const WARD_DISTRICT_DATA = rawData.map((item)=>({
        ...item,
        provinceId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["asBusinessId"])(typeof item.provinceId === 'number' ? item.provinceId.toString().padStart(2, '0') : item.provinceId),
...
//# sourceMappingURL=features_settings_provinces_ward-district-data_ts_51552ffe._.js.map