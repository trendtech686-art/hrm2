...
"[project]/features/purchase-orders/hooks/use-all-purchase-orders.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAllPurchaseOrders() {
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$purchase$2d$orders$2f$hooks$2f$use$2d$purchase$2d$orders$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePurchaseOrders"])({
        limit: 500
    });
    return {
...
function usePurchaseOrdersBySupplier(supplierSystemId) {
    ...
    const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>supplierSystemId ? data.filter((po)=>po.supplierSystemId === supplierSystemId) : [], [
        data,
        supplierSystemId
    ]);
    return {
...
//# sourceMappingURL=features_238b8315._.js.map