...
"[project]/features/cashbook/api/cashbook-api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchCashAccounts(filters = {}) {
...
async function fetchCashAccountById(systemId) {
    const response = await fetch(`${BASE_URL}/${systemId}`);
    if (!response.ok) {
...
async function updateCashAccount(systemId, data) {
    const response = await fetch(`${BASE_URL}/${systemId}`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json'
...
async function deleteCashAccount(systemId) {
    const response = await fetch(`${BASE_URL}/${systemId}`, {
        method: 'DELETE'
    });
    if (!response.ok) {
...
async function setDefaultCashAccount(systemId) {
...
async function fetchAccountBalance(systemId) {
...
"[project]/features/cashbook/hooks/use-cashbook.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "cashbookKeys",
    ()=>cashbookKeys,
    "useActiveCashAccounts",
    ()=>useActiveCashAccounts,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query/build/modern/useMutation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/cashbook/api/cashbook-api.ts [app-ssr] (ecmascript)");
;
;
const cashbookKeys = {
    all: [
...
function useCashAccounts(filters = {}) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: cashbookKeys.list(filters),
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCashAccounts"])(filters),
        staleTime: 1000 * 60 * 5
    });
}
function useActiveCashAccounts() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: cashbookKeys.active(),
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchActiveCashAccounts"],
        staleTime: 1000 * 60 * 10
    });
}
function useCashAccountById(systemId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: cashbookKeys.detail(systemId),
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCashAccountById"])(systemId),
        enabled: !!systemId,
        staleTime: 1000 * 60 * 5
    });
}
function useCashAccountBalance(systemId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: cashbookKeys.balance(systemId),
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAccountBalance"])(systemId),
        enabled: !!systemId,
        staleTime: 1000 * 30
    });
}
function useCashAccountMutations(options = {}) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueryClient"])();
    ...
    const create = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCashAccount"])(data),
        onSuccess: ()=>{
            invalidateCashbook();
            options.onSuccess?.();
        },
    ...
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: ({ systemId, data })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCashAccount"])(systemId, data),
        onSuccess: ()=>{
            invalidateCashbook();
            options.onSuccess?.();
        },
    ...
    const remove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (systemId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteCashAccount"])(systemId),
        onSuccess: ()=>{
            invalidateCashbook();
            options.onSuccess?.();
        },
    ...
    const setDefault = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (systemId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$cashbook$2f$api$2f$cashbook$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDefaultCashAccount"])(systemId),
        onSuccess: ()=>{
            invalidateCashbook();
            options.onSuccess?.();
        },
...
function useCashAccountsByType(type) {
...
//# sourceMappingURL=features_38b1e1cc._.js.map