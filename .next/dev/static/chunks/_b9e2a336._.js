...
"[project]/lib/import-export/configs/receipt.config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getReceiptTypeStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$receipt$2d$types$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReceiptTypeStore"].getState();
...
const findReceiptType = (identifier)=>{
    if (!identifier) return undefined;
...
const findPayer = (payerType, payerName)=>{
...
const receiptImportExportConfig = {
    entityType: 'receipts',
    ...
    validateRow: (row, _index, existingData, mode)=>{
        ...
        if (!receipt.payerName?.trim()) {
            errors.push({
                field: 'payerName',
                message: 'Người nộp không được để trống'
            });
        }
        if (!receipt.paymentReceiptTypeName) {
            errors.push({
                field: 'paymentReceiptTypeName',
                message: 'Loại phiếu thu không được để trống'
            });
        }
        // Check duplicate
        if (mode === 'insert-only' && receipt.id) {
            const duplicate = existingData.find((r)=>r.id.toString().toUpperCase() === receipt.id.toString().toUpperCase());
            if (duplicate) {
                errors.push({
                    field: 'id',
                    message: `Mã phiếu "${receipt.id}" đã tồn tại`
                });
            }
        }
        return errors;
    ...
    postTransformRow: (row)=>{
        ...
        const receiptType = findReceiptType(row.paymentReceiptTypeName);
        const paymentMethod = findPaymentMethod(row.paymentMethodName) || defaultPaymentMethod;
        const targetGroup = findTargetGroup(row.payerTypeName);
        const payer = findPayer(row.payerTypeName || '', row.payerName || '');
        return {
            systemId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(''),
            ...
            payerTypeSystemId: targetGroup?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])('KHAC'),
            ...
            paymentReceiptTypeSystemId: receiptType?.systemId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(''),
...
"[project]/features/receipts/components/receipt-import-export-dialogs.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ReceiptImportDialog({ open, onOpenChange, branches, existingData, onImport, currentUser }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$import$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericImportDialogV2"], {
        ...
        fileName: "[project]/features/receipts/components/receipt-import-export-dialogs.tsx",
        lineNumber: 57,
        columnNumber: 9
    }, this);
}
_c = ReceiptImportDialog;
function ReceiptExportDialog({ open, onOpenChange, allData, filteredData, currentPageData, selectedData, currentUser }) {
...
_c1 = ReceiptExportDialog;
var _c, _c1;
__turbopack_context__.k.register(_c, "ReceiptImportDialog");
__turbopack_context__.k.register(_c1, "ReceiptExportDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/features/receipts/components/receipt-import-export-dialogs.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/features/receipts/components/receipt-import-export-dialogs.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=_b9e2a336._.js.map