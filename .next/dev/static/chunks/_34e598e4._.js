...
"[project]/lib/import-export/configs/supplier.config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const supplierImportExportConfig = {
    ...
    validateRow: (row, _index, existingData, mode)=>{
        ...
        if (!supplier.id?.toString().trim()) {
            errors.push({
                field: 'id',
                message: 'Mã NCC không được để trống'
            });
        }
        // Tên NCC bắt buộc
        if (!supplier.name?.trim()) {
            errors.push({
                field: 'name',
                message: 'Tên NCC không được để trống'
            });
        }
        // SĐT bắt buộc
        ...
        if (mode === 'insert-only' && supplier.id) {
            const duplicate = existingData.find((s)=>s.id.toString().toUpperCase() === supplier.id.toString().toUpperCase());
            if (duplicate) {
                errors.push({
                    field: 'id',
                    message: `Mã NCC "${supplier.id}" đã tồn tại`
                });
            }
        }
        // Validate status
...
"[project]/features/suppliers/components/suppliers-import-export-dialogs.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function SupplierImportDialog({ open, onOpenChange, existingData, branches, onImport, currentUser }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$import$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericImportDialogV2"], {
        ...
        fileName: "[project]/features/suppliers/components/suppliers-import-export-dialogs.tsx",
        lineNumber: 41,
        columnNumber: 5
    }, this);
}
_c = SupplierImportDialog;
function SupplierExportDialog({ open, onOpenChange, allData, filteredData, currentPageData, selectedData, currentUser }) {
...
_c1 = SupplierExportDialog;
var _c, _c1;
__turbopack_context__.k.register(_c, "SupplierImportDialog");
__turbopack_context__.k.register(_c1, "SupplierExportDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/features/suppliers/components/suppliers-import-export-dialogs.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/features/suppliers/components/suppliers-import-export-dialogs.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=_34e598e4._.js.map