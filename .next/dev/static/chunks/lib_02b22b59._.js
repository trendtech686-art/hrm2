...
"[project]/lib/print/sales-return-print-helper.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
function convertSalesReturnForPrint(salesReturn, options = {}) {
    ...
    return {
        ...
        ].filter(Boolean).join(', ') : originalOrder?.shippingAddress || '',
...
function createStoreSettingsFromBranch(branch, storeInfo) {
    return {
...
//# sourceMappingURL=lib_02b22b59._.js.map