...
"[project]/node_modules/@tiptap/suggestion/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function findSuggestionMatch(config) {
    ...
    const escapedChar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeForRegEx"])(char);
...
// src/suggestion.ts
var SuggestionPluginKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"]("suggestion");
function Suggestion({ pluginKey = SuggestionPluginKey, editor, char = "@", allowSpaces = false, allowToIncludeChar = false, allowedPrefixes = [
    " "
], startOfLine = false, decorationTag = "span", decorationClass = "suggestion", decorationContent = "", decorationEmptyClass = "is-empty", command = ()=>null, items = ()=>[], render = ()=>({}), allow = ()=>true, findSuggestionMatch: findSuggestionMatch2 = findSuggestionMatch }) {
    let props;
        ...
        props: {
            ...
            handleKeyDown (view, event) {
                ...
                if (event.key === "Escape" || event.key === "Esc") {
                    ...
                    const handledByKeyDown = ((_b = renderer == null ? void 0 : renderer.onKeyDown) == null ? void 0 : _b.call(renderer, {
                        view,
                        event,
                        range: state.range
                    })) || false;
                ...
                const handled = ((_d = renderer == null ? void 0 : renderer.onKeyDown) == null ? void 0 : _d.call(renderer, {
                    view,
                    event,
                    range
                })) || false;
            ...
            decorations (state) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].create(state.doc, [
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].inline(range.from, range.to, {
...
"[project]/node_modules/@tiptap/extension-mention/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getSuggestionOptions({ editor: tiptapEditor, overrideSuggestionOptions, extensionName, char = "@" }) {
    const pluginKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"]();
    return {
        editor: tiptapEditor,
        char,
        pluginKey,
...
var Mention = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    name: "mention",
    priority: 101,
    addOptions () {
        return {
            ...
            renderHTML ({ options, node, suggestion }) {
                ...
                return [
                    "span",
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"])(this.HTMLAttributes, options.HTMLAttributes),
    ...
    renderHTML ({ node, HTMLAttributes }) {
        ...
        if (this.options.renderLabel !== void 0) {
            ...
            return [
                "span",
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"])({
                    "data-type": this.name
        ...
        mergedOptions.HTMLAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"])({
            "data-type": this.name
        }, this.options.HTMLAttributes, HTMLAttributes);
    ...
    ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createInlineMarkdownSpec"])({
        nodeName: "mention",
        name: "@",
        selfClosing: true,
        allowedAttributes: [
    ...
    addKeyboardShortcuts () {
        return {
            Backspace: ()=>this.editor.commands.command(({ tr, state })=>{
                    ...
                    let mentionNode = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"]();
                    let mentionPos = 0;
    ...
    addProseMirrorPlugins () {
        return getSuggestions(this).map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$suggestion$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suggestion"]);
    }
});
// src/index.ts
...
//# sourceMappingURL=node_modules_%40tiptap_450933a6._.js.map