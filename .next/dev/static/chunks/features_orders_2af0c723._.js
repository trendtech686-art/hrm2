...
function OrdersPage() {
    ...
    // ✅ Migrated to React Query - useOrderActions for cancel action
    const { cancel: cancelOrderMutation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$hooks$2f$use$2d$order$2d$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderActions"])({
        onSuccess: {
            "OrdersPage.useOrderActions": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Hủy đơn hàng thành công')
        }["OrdersPage.useOrderActions"],
        onError: {
            "OrdersPage.useOrderActions": (error)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Lỗi hủy đơn: ${error.message}`)
        }["OrdersPage.useOrderActions"]
    });
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
...
_s(OrdersPage, "xzKL6hmLHOdRBkEC9P6pGbgTDHo=", false, function() {
    return [
...
//# sourceMappingURL=features_orders_2af0c723._.js.map