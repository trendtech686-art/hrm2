...
"[project]/lib/import-export/configs/inventory-check.config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    "flattenInventoryChecksForExport",
    ()=>flattenInventoryChecksForExport,
    "inventoryCheckFields",
    ()=>inventoryCheckFields,
    "inventoryCheckImportExportConfig",
    ()=>inventoryCheckImportExportConfig
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$products$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/products/store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$branches$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/branches/store.ts [app-client] (ecmascript)");
...
const _getEmployeeStore = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$employees$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmployeeStore"].getState();
...
const inventoryCheckImportExportConfig = {
    entityType: 'inventory-checks',
    entityDisplayName: 'Phiếu kiểm kê',
    fields: inventoryCheckFields,
    ...
    validateRow: (row, _index, existingData, mode)=>{
        ...
        if (importRow.systemQuantity === undefined || importRow.systemQuantity < 0) {
            errors.push({
                ...
                message: 'SL hệ thống không hợp lệ'
            });
        }
        if (importRow.actualQuantity === undefined || importRow.actualQuantity < 0) {
            errors.push({
                field: 'actualQuantity',
                message: 'SL thực tế không hợp lệ'
            });
        }
        // Check duplicate
        if (mode === 'insert-only' && importRow.checkId) {
            const duplicate = existingData.find((c)=>c.id.toUpperCase() === importRow.checkId.toUpperCase());
            if (duplicate) {
        ...
        for (const [checkId, rows] of checkMap.entries()){
            ...
            for (const row of rows){
                ...
                items.push({
                    ...
                    productId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asBusinessId"])(product?.id || row.productIdOrSku || ''),
            ...
            const check = {
                systemId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(''),
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asBusinessId"])(checkId),
...
function flattenInventoryChecksForExport(checks) {
    const rows = [];
...
"[project]/features/inventory-checks/components/inventory-checks-import-export-dialogs.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function InventoryCheckImportDialog({ open, onOpenChange, existingData, branches, onImport, currentUser }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$import$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericImportDialogV2"], {
        ...
        fileName: "[project]/features/inventory-checks/components/inventory-checks-import-export-dialogs.tsx",
        lineNumber: 41,
        columnNumber: 5
    }, this);
}
_c = InventoryCheckImportDialog;
function InventoryCheckExportDialog({ open, onOpenChange, allData, filteredData, currentPageData, selectedData, currentUser }) {
...
"[project]/features/inventory-checks/components/inventory-checks-import-export-dialogs.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/features/inventory-checks/components/inventory-checks-import-export-dialogs.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=_4c10a91f._.js.map