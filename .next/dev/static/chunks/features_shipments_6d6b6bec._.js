...
"[project]/features/shipments/api/shipments-api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/features/shipments/hooks/use-shipments.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/shipments/api/shipments-api.ts [app-client] (ecmascript)");
...
function useShipments(filters = {}) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useShipments.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShipments"])(filters)
        }["useShipments.useQuery"],
        staleTime: 1000 * 60
    });
}
_s(useShipments, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
...
function useShipmentById(systemId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useShipmentById.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShipmentById"])(systemId)
        }["useShipmentById.useQuery"],
        enabled: !!systemId,
        staleTime: 1000 * 30
    });
}
_s1(useShipmentById, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
function useShipmentsByOrder(orderId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useShipmentsByOrder.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShipments"])({
                    orderId: orderId,
                    limit: 50
                })
        }["useShipmentsByOrder.useQuery"],
        enabled: !!orderId,
        staleTime: 1000 * 60
    });
}
_s2(useShipmentsByOrder, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
function useShipmentMutations(options = {}) {
    ...
    const create = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[create]": (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createShipment"])(data)
        }["useShipmentMutations.useMutation[create]"],
        onSuccess: {
            "useShipmentMutations.useMutation[create]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[update]": ({ systemId, data })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateShipment"])(systemId, data)
        }["useShipmentMutations.useMutation[update]"],
        onSuccess: {
            "useShipmentMutations.useMutation[update]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const remove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[remove]": (systemId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteShipment"])(systemId)
        }["useShipmentMutations.useMutation[remove]"],
        onSuccess: {
            "useShipmentMutations.useMutation[remove]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const updateStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[updateStatus]": ({ systemId, status, timestamp })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDeliveryStatus"])(systemId, status, timestamp)
        }["useShipmentMutations.useMutation[updateStatus]"],
        onSuccess: {
            "useShipmentMutations.useMutation[updateStatus]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const reconcile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[reconcile]": (systemId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reconcileShipment"])(systemId)
        }["useShipmentMutations.useMutation[reconcile]"],
        onSuccess: {
            "useShipmentMutations.useMutation[reconcile]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const bulkReconcile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[bulkReconcile]": (systemIds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bulkReconcileShipments"])(systemIds)
        }["useShipmentMutations.useMutation[bulkReconcile]"],
        onSuccess: {
            "useShipmentMutations.useMutation[bulkReconcile]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const syncTracking = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[syncTracking]": (systemId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncTrackingInfo"])(systemId)
        }["useShipmentMutations.useMutation[syncTracking]"],
        onSuccess: {
            "useShipmentMutations.useMutation[syncTracking]": ()=>{
                invalidateShipments();
                options.onSuccess?.();
    ...
    const printLabels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useShipmentMutations.useMutation[printLabels]": (systemIds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$api$2f$shipments$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["printShippingLabel"])(systemIds)
        }["useShipmentMutations.useMutation[printLabels]"],
        onError: options.onError
    });
    return {
        create,
...
_s3(useShipmentMutations, "sMnT9zMLUVJ2vOplmvwjN/P36WQ=", false, function() {
    return [
...
_s4(usePendingShipments, "JDr/npvkLWHysbX7f8AGauD/ABA=", false, function() {
    return [
        useShipments
    ];
});
...
_s5(useShipmentsInTransit, "JDr/npvkLWHysbX7f8AGauD/ABA=", false, function() {
    return [
        useShipments
    ];
});
...
"[project]/features/shipments/hooks/use-all-shipments.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$hooks$2f$use$2d$shipments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/shipments/hooks/use-shipments.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
function useAllShipments() {
    _s();
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$hooks$2f$use$2d$shipments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShipments"])({});
    return {
...
_s(useAllShipments, "dFgfkRxUClFUFrhKEacbCPfHLNM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$hooks$2f$use$2d$shipments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShipments"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/features/shipments/columns.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getColumns = (onPrintDelivery, onPrintHandover, navigate)=>[
        ...
        },
        {
            ...
            cell: ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.packagingDate),
            meta: {
        ...
        },
        {
            ...
            cell: ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.cancelledAt),
            meta: {
        ...
        },
        {
            ...
            cell: ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.dispatchedAt),
            meta: {
...
"[project]/features/shipments/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/print/shipment-print-helper.ts [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/shipments/columns.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$shipment$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/import-export/configs/shipment.config.ts [app-client] (ecmascript)");
...
function ShipmentsPage() {
    _s();
    const { data: shipmentsData = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$hooks$2f$use$2d$all$2d$shipments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAllShipments"])();
    const { data: allOrders = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$hooks$2f$use$2d$all$2d$orders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAllOrders"])();
    const { data: allCustomers = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$hooks$2f$use$2d$all$2d$customers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAllCustomers"])();
    ...
    const [printType, setPrintType] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]('delivery');
    // Export dialog state
    ...
    const [partnerFilter, setPartnerFilter] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]('all');
    ...
    const [columnVisibility, setColumnVisibility] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
        "ShipmentsPage.useState": ()=>{
            const cols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumns"])();
            const initial = {};
            cols.forEach({
                "ShipmentsPage.useState": (c)=>{
    ...
    const mobileScrollRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ShipmentsPage.useEffect": ()=>{
            const timer = setTimeout({
                "ShipmentsPage.useEffect.timer": ()=>setDebouncedGlobalFilter(globalFilter)
            }["ShipmentsPage.useEffect.timer"], 300);
            return ({
                "ShipmentsPage.useEffect": ()=>clearTimeout(timer)
            })["ShipmentsPage.useEffect"];
        }
    }["ShipmentsPage.useEffect"], [
        globalFilter
    ...
    const shipments = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[shipments]": ()=>{
            return shipmentsData.map({
                "ShipmentsPage.useMemo[shipments]": (shipment)=>{
                    const order = allOrders.find({
                        "ShipmentsPage.useMemo[shipments].order": (o)=>o.systemId === shipment.orderSystemId
                    }["ShipmentsPage.useMemo[shipments].order"]);
                    const customer = order ? allCustomers.find({
                        "ShipmentsPage.useMemo[shipments]": (c)=>c.systemId === order.customerSystemId
                    }["ShipmentsPage.useMemo[shipments]"]) : null;
                    const packaging = order?.packagings.find({
                        "ShipmentsPage.useMemo[shipments]": (p)=>p.systemId === shipment.packagingSystemId
                    }["ShipmentsPage.useMemo[shipments]"]);
                    const totalPaid = order?.payments.reduce({
                        "ShipmentsPage.useMemo[shipments]": (sum, p)=>sum + p.amount
                    }["ShipmentsPage.useMemo[shipments]"], 0) || 0;
                    ...
                    return {
                        ...
                        // Calculated
                        totalProductQuantity: order?.lineItems.reduce({
                            "ShipmentsPage.useMemo[shipments]": (sum, item)=>sum + item.quantity
                        }["ShipmentsPage.useMemo[shipments]"], 0) || 0,
    ...
    const handlePrintDelivery = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handlePrintDelivery]": (shipmentIds)=>{
            shipmentIds.forEach({
                "ShipmentsPage.useCallback[handlePrintDelivery]": (id)=>{
                    const shipment = shipments.find({
                        "ShipmentsPage.useCallback[handlePrintDelivery].shipment": (s)=>s.systemId === id
                    }["ShipmentsPage.useCallback[handlePrintDelivery].shipment"]);
                    if (!shipment) return;
                    const order = allOrders.find({
                        "ShipmentsPage.useCallback[handlePrintDelivery].order": (o)=>o.systemId === shipment.orderSystemId
                    }["ShipmentsPage.useCallback[handlePrintDelivery].order"]);
                    if (!order) return;
                    const customer = allCustomers.find({
                        "ShipmentsPage.useCallback[handlePrintDelivery].customer": (c)=>c.systemId === order.customerSystemId
                    }["ShipmentsPage.useCallback[handlePrintDelivery].customer"]);
                    // Use helper to prepare print data
                    const storeSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(storeInfo);
                    const deliveryData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertShipmentToDeliveryForPrint"])(shipment, order, {
                        customer
                    });
                    print('delivery', {
            ...
            }["ShipmentsPage.useCallback[handlePrintDelivery]"]);
        }
    }["ShipmentsPage.useCallback[handlePrintDelivery]"], [
        shipments,
        allOrders,
    ...
    const handlePrintHandover = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handlePrintHandover]": (shipmentIds)=>{
            const selectedShipments = shipments.filter({
                "ShipmentsPage.useCallback[handlePrintHandover].selectedShipments": (s)=>shipmentIds.includes(s.systemId)
            }["ShipmentsPage.useCallback[handlePrintHandover].selectedShipments"]);
            if (selectedShipments.length === 0) return;
            // Use helper to prepare print data
            const storeSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(storeInfo);
            const handoverData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertShipmentsToHandoverForPrint"])(selectedShipments);
            print('handover', {
                data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mapHandoverToPrintData"])(handoverData, storeSettings),
                lineItems: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mapHandoverLineItems"])(handoverData.orders)
            });
        }
    }["ShipmentsPage.useCallback[handlePrintHandover]"], [
        shipments,
        storeInfo,
        print
    ]);
    const handlePrintSingleDelivery = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handlePrintSingleDelivery]": (shipmentId)=>{
            handlePrintDelivery([
                shipmentId
            ]);
        }
    }["ShipmentsPage.useCallback[handlePrintSingleDelivery]"], [
        handlePrintDelivery
    ]);
    const handlePrintSingleHandover = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handlePrintSingleHandover]": (shipmentId)=>{
            handlePrintHandover([
                shipmentId
            ]);
        }
    }["ShipmentsPage.useCallback[handlePrintSingleHandover]"], [
        handlePrintHandover
    ]);
    // Bulk print handlers
    const handleBulkPrintDelivery = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handleBulkPrintDelivery]": (rows)=>{
            setItemsToPrint(rows);
            setPrintType('delivery');
            setPrintDialogOpen(true);
        }
    }["ShipmentsPage.useCallback[handleBulkPrintDelivery]"], []);
    const handleBulkPrintHandover = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handleBulkPrintHandover]": (rows)=>{
            setItemsToPrint(rows);
            setPrintType('handover');
            setPrintDialogOpen(true);
        }
    }["ShipmentsPage.useCallback[handleBulkPrintHandover]"], []);
    const handlePrintConfirm = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ShipmentsPage.useCallback[handlePrintConfirm]": (options)=>{
            if (itemsToPrint.length === 0) return;
            if (printType === 'delivery') {
                const printItems = itemsToPrint.map({
                    "ShipmentsPage.useCallback[handlePrintConfirm].printItems": (shipment)=>{
                        const order = allOrders.find({
                            "ShipmentsPage.useCallback[handlePrintConfirm].printItems.order": (o)=>o.systemId === shipment.orderSystemId
                        }["ShipmentsPage.useCallback[handlePrintConfirm].printItems.order"]);
                        const customer = order ? allCustomers.find({
                            "ShipmentsPage.useCallback[handlePrintConfirm].printItems": (c)=>c.systemId === order.customerSystemId
                        }["ShipmentsPage.useCallback[handlePrintConfirm].printItems"]) : null;
                        const selectedBranch = options.branchSystemId ? branches.find({
                            "ShipmentsPage.useCallback[handlePrintConfirm].printItems": (b)=>b.systemId === options.branchSystemId
                        }["ShipmentsPage.useCallback[handlePrintConfirm].printItems"]) : null;
                        const storeSettings = selectedBranch ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(selectedBranch) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(storeInfo);
                        const deliveryData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertShipmentToDeliveryForPrint"])(shipment, order, {
                            customer
                        });
                        return {
                ...
                }["ShipmentsPage.useCallback[handlePrintConfirm].printItems"]).filter({
                    "ShipmentsPage.useCallback[handlePrintConfirm].printItems": (item)=>item.data
                }["ShipmentsPage.useCallback[handlePrintConfirm].printItems"]);
                printMultiple('delivery', printItems);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Đang in ${printItems.length} phiếu giao hàng`);
            } else {
                // Handover is a single document containing all selected shipments
                const selectedBranch = options.branchSystemId ? branches.find({
                    "ShipmentsPage.useCallback[handlePrintConfirm]": (b)=>b.systemId === options.branchSystemId
                }["ShipmentsPage.useCallback[handlePrintConfirm]"]) : null;
                const storeSettings = selectedBranch ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(selectedBranch) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(storeInfo);
                const handoverData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertShipmentsToHandoverForPrint"])(itemsToPrint);
                print('handover', {
                    data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mapHandoverToPrintData"])(handoverData, storeSettings),
                    lineItems: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$shipment$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mapHandoverLineItems"])(handoverData.orders)
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Đang in phiếu bàn giao');
            }
            setItemsToPrint([]);
            setPrintDialogOpen(false);
        }
    }["ShipmentsPage.useCallback[handlePrintConfirm]"], [
        itemsToPrint,
        printType,
        allOrders,
        allCustomers,
    ...
    const bulkActions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[bulkActions]": ()=>[
                {
    ...
    const columns = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[columns]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$shipments$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumns"])(handlePrintSingleDelivery, handlePrintSingleHandover, {
                "ShipmentsPage.useMemo[columns]": (path)=>router.push(path)
            }["ShipmentsPage.useMemo[columns]"])
    }["ShipmentsPage.useMemo[columns]"], [
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ShipmentsPage.useEffect": ()=>{
            ...
            setColumnOrder(columns.map({
                "ShipmentsPage.useEffect": (c)=>c.id
            }["ShipmentsPage.useEffect"]).filter(Boolean));
            hasInitializedVisibility.current = true;
        }
    }["ShipmentsPage.useEffect"], [
        columns,
    ...
    const fuseInstance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[fuseInstance]": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fuse$2e$js$2f$dist$2f$fuse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](shipments, {
                keys: [
                    'trackingCode',
                    'customerName',
                    'customerPhone',
    ...
    }["ShipmentsPage.useMemo[fuseInstance]"], [
        shipments
    ]);
    const shipmentStats = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[shipmentStats]": ()=>{
            return shipments.reduce({
                "ShipmentsPage.useMemo[shipmentStats]": (acc, shipment)=>{
                    acc.total += 1;
    ...
    const shippingPartners = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[shippingPartners]": ()=>{
            const partners = new Set();
            shipments.forEach({
                "ShipmentsPage.useMemo[shippingPartners]": (s)=>{
    ...
    const filteredData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[filteredData]": ()=>{
            let data = shipments;
            if (branchFilter !== 'all') data = data.filter({
                "ShipmentsPage.useMemo[filteredData]": (s)=>s.branchName === branches.find({
                        "ShipmentsPage.useMemo[filteredData]": (b)=>b.systemId === branchFilter
                    }["ShipmentsPage.useMemo[filteredData]"])?.name
            }["ShipmentsPage.useMemo[filteredData]"]);
            if (statusFilter !== 'all') data = data.filter({
                "ShipmentsPage.useMemo[filteredData]": (s)=>s.deliveryStatus === statusFilter
            }["ShipmentsPage.useMemo[filteredData]"]);
            if (partnerFilter !== 'all') data = data.filter({
                "ShipmentsPage.useMemo[filteredData]": (s)=>s.carrier === partnerFilter
            }["ShipmentsPage.useMemo[filteredData]"]);
            if (debouncedGlobalFilter && debouncedGlobalFilter.trim()) {
                fuseInstance.setCollection(data);
                data = fuseInstance.search(debouncedGlobalFilter.trim()).map({
                    "ShipmentsPage.useMemo[filteredData]": (r)=>r.item
                }["ShipmentsPage.useMemo[filteredData]"]);
            }
            return data;
        }
    ...
    const sortedData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[sortedData]": ()=>{
            const sorted = [
                ...filteredData
            ];
            if (sorting.id) {
                sorted.sort({
                    "ShipmentsPage.useMemo[sortedData]": (a, b)=>{
    ...
    const paginatedData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[paginatedData]": ()=>{
    ...
    const allSelectedRows = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ShipmentsPage.useMemo[allSelectedRows]": ()=>shipments.filter({
                "ShipmentsPage.useMemo[allSelectedRows]": (s)=>rowSelection[s.systemId]
            }["ShipmentsPage.useMemo[allSelectedRows]"])
    }["ShipmentsPage.useMemo[allSelectedRows]"], [
        shipments,
        rowSelection
    ]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ShipmentsPage.useEffect": ()=>{
            if (!isMobile) return;
            const handleScroll = {
                "ShipmentsPage.useEffect.handleScroll": ()=>{
                    ...
                    if (scrollTop + clientHeight >= scrollHeight * 0.8 && mobileLoadedCount < sortedData.length) {
                        setMobileLoadedCount({
                            "ShipmentsPage.useEffect.handleScroll": (prev)=>Math.min(prev + 20, sortedData.length)
                        }["ShipmentsPage.useEffect.handleScroll"]);
                    }
                }
            }["ShipmentsPage.useEffect.handleScroll"];
            ...
            return ({
                "ShipmentsPage.useEffect": ()=>window.removeEventListener('scroll', handleScroll)
            })["ShipmentsPage.useEffect"];
        }
    }["ShipmentsPage.useEffect"], [
        isMobile,
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(shipment.createdAt)
                                    }, void 0, false, {
                                        fileName: "[project]/features/shipments/page.tsx",
                                        lineNumber: 412,
                                        columnNumber: 29
                            ...
                            shipment.customerAddress && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center text-xs text-muted-foreground",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$map$2d$pin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__MapPin$3e$__["MapPin"], {
                                        className: "h-3 w-3 mr-1.5 flex-shrink-0"
                            ...
                            shipment.carrier && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center text-xs text-muted-foreground",
                                children: [
        ...
        children: [
            ...
            isMobile ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: sortedData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        sortedData.slice(0, mobileLoadedCount).map((shipment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MobileShipmentCard, {
                                shipment: shipment
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2d$table$2f$responsive$2d$data$2d$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveDataTable"], {
                    columns: columns,
                    data: paginatedData,
                    renderMobileCard: (shipment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MobileShipmentCard, {
                            shipment: shipment
                        }, void 0, false, {
                            fileName: "[project]/features/shipments/page.tsx",
                            lineNumber: 501,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$export$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericExportDialogV2"], {
                ...
                config: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$shipment$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shipmentConfig"],
                allData: shipments,
...
_s(ShipmentsPage, "lAUpZFklvNCD7+WmgBtH0ZzaOXA=", false, function() {
    return [
...
//# sourceMappingURL=features_shipments_6d6b6bec._.js.map