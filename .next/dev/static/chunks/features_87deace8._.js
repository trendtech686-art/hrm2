...
"[project]/features/purchase-orders/hooks/use-all-purchase-orders.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "useAllPurchaseOrders",
    ()=>useAllPurchaseOrders,
    "usePurchaseOrderFinder",
    ()=>usePurchaseOrderFinder,
    "usePurchaseOrdersBySupplier",
    ()=>usePurchaseOrdersBySupplier
]);
...
;
;
function useAllPurchaseOrders() {
    _s();
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$purchase$2d$orders$2f$hooks$2f$use$2d$purchase$2d$orders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePurchaseOrders"])({
        limit: 500
    });
    return {
...
_s(useAllPurchaseOrders, "+6Zgj2NOGOkmPLgqlrCyudaBBzc=", false, function() {
    return [
...
function usePurchaseOrderFinder() {
    _s1();
    ...
    const findById = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "usePurchaseOrderFinder.useCallback[findById]": (systemId)=>{
            if (!systemId) return undefined;
            return data.find({
                "usePurchaseOrderFinder.useCallback[findById]": (po)=>po.systemId === systemId
            }["usePurchaseOrderFinder.useCallback[findById]"]);
        }
    }["usePurchaseOrderFinder.useCallback[findById]"], [
        data
    ]);
...
_s1(usePurchaseOrderFinder, "JfFCHDIxAxPleO2IGVSvCj7DXH8=", false, function() {
    return [
        useAllPurchaseOrders
    ];
});
function usePurchaseOrdersBySupplier(supplierSystemId) {
    _s2();
    ...
    const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "usePurchaseOrdersBySupplier.useMemo[filtered]": ()=>supplierSystemId ? data.filter({
                "usePurchaseOrdersBySupplier.useMemo[filtered]": (po)=>po.supplierSystemId === supplierSystemId
            }["usePurchaseOrdersBySupplier.useMemo[filtered]"]) : []
    }["usePurchaseOrdersBySupplier.useMemo[filtered]"], [
        data,
        supplierSystemId
    ]);
...
_s2(usePurchaseOrdersBySupplier, "pnj0raPeJhJTnR/EAaOHntyJnZU=", false, function() {
    return [
        useAllPurchaseOrders
    ];
});
...
//# sourceMappingURL=features_87deace8._.js.map