...
function ProvinceForm({ initialData, onSubmit, onCancel }) {
    _s();
    const { data: _provinces } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$provinces$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProvinceStore"])();
...
_s(ProvinceForm, "Lt6Nf6DtCJgFMoFRPh2DCN1lj2U=", false, function() {
    return [
...
const ProvinceItem = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"](function ProvinceItem({ province, isActive, onSelect, onEdit, onDelete, _index }) {
...
function ProvincesPage() {
    _s2();
    const { data: provinces, add, update, remove, addWard, updateWard, removeWard, addDistrict, updateDistrict, removeDistrict, getWards2LevelByProvinceId, getWards3LevelByDistrictId, getDistricts3LevelByProvinceId, importAdministrativeUnits } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$provinces$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProvinceStore"])();
    ...
    const districtsForProvince = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ProvincesPage.useMemo[districtsForProvince]": ()=>{
    ...
    const handleProvinceFormSubmit = (values)=>{
        if (editingProvince) {
            update(editingProvince.systemId, {
                ...editingProvince,
                ...values
            });
        } else {
    ...
    const handleWardFormSubmit = (values)=>{
        ...
        if (editingWard) {
            updateWard(editingWard.systemId, {
                ...editingWard,
                ...finalValues
            });
        } else {
    ...
    const handleDistrictFormSubmit = (values)=>{
        ...
        if (editingDistrict) {
            updateDistrict(editingDistrict.systemId, {
                ...editingDistrict,
                ...finalValues
            });
        } else {
    ...
    const confirmDelete = ()=>{
        ...
        if (dialogState.type === "province") {
            ...
            remove((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(dialogState.systemId));
        } else if (dialogState.type === "ward") {
            removeWard((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(dialogState.systemId));
            ...
            removeDistrict((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asSystemId"])(dialogState.systemId));
        }
        setDialogState(null);
    };
    ...
    const handleExport = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ProvincesPage.useCallback[handleExport]": async ()=>{
            const provincesToExport = provinces.map({
                "ProvincesPage.useCallback[handleExport].provincesToExport": ({ systemId: _systemId, ...rest })=>({
                        "Mã tỉnh": rest.id,
                        "Tên Tỉnh/Thành phố": rest.name
                    })
            }["ProvincesPage.useCallback[handleExport].provincesToExport"]);
            const wards2Level = getWards2LevelByProvinceId((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asBusinessId"])("08"));
            const wardsToExport = wards2Level.map({
                "ProvincesPage.useCallback[handleExport].wardsToExport": ({ systemId: _systemId, ...rest })=>({
...
_s2(ProvincesPage, "QycF5r7tXlP1H6so1Az6Gv+Rsfc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$provinces$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProvinceStore"],
        useDebounce,
        useDebounce,
...
//# sourceMappingURL=_87b4825c._.js.map