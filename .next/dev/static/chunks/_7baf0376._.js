...
"[project]/hooks/use-reminder-settings.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DEFAULT_WARRANTY_REMINDER_TEMPLATES",
    ()=>DEFAULT_WARRANTY_REMINDER_TEMPLATES,
    "useComplaintReminderSettings",
    ()=>useComplaintReminderSettings,
    "useWarrantyReminderTemplates",
    ()=>useWarrantyReminderTemplates
]);
/**
...
const DEFAULT_WARRANTY_REMINDER_TEMPLATES = [
    {
        id: 'overdue',
...
function useWarrantyReminderTemplates() {
    _s();
    ...
    const [customTemplates, setCustomTemplatesState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    // Load from database
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useWarrantyReminderTemplates.useEffect": ()=>{
            const loadTemplates = {
                "useWarrantyReminderTemplates.useEffect.loadTemplates": async ()=>{
                    try {
                        if (user?.systemId) {
                            const res = await fetch(`${API_BASE}?userId=${user.systemId}&key=${encodeURIComponent(WARRANTY_REMINDER_TEMPLATES_KEY)}`);
                            if (res.ok) {
            ...
            }["useWarrantyReminderTemplates.useEffect.loadTemplates"];
            loadTemplates();
        }
    }["useWarrantyReminderTemplates.useEffect"], [
        user?.systemId
    ...
    const setTemplates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useWarrantyReminderTemplates.useCallback[setTemplates]": (newTemplates)=>{
            // Filter out default templates
            const customOnly = newTemplates.filter({
                "useWarrantyReminderTemplates.useCallback[setTemplates].customOnly": (t)=>!t.isDefault
            }["useWarrantyReminderTemplates.useCallback[setTemplates].customOnly"]);
            ...
            if (user?.systemId) {
                ...
                saveTimeoutRef.current = setTimeout({
                    "useWarrantyReminderTemplates.useCallback[setTemplates]": ()=>{
                        ...
                        fetch(API_BASE, {
                            ...
                            "useWarrantyReminderTemplates.useCallback[setTemplates]": (error)=>{
                                console.error('Error saving warranty reminder templates:', error);
                            }
                        }["useWarrantyReminderTemplates.useCallback[setTemplates]"]);
                    }
                }["useWarrantyReminderTemplates.useCallback[setTemplates]"], SAVE_DEBOUNCE_DELAY);
            }
        }
    }["useWarrantyReminderTemplates.useCallback[setTemplates]"], [
        user?.systemId
...
_s(useWarrantyReminderTemplates, "4XwKXkBZqxAmk/Y0IN7lkSCy8VU=", false, function() {
    return [
...
const DEFAULT_COMPLAINT_REMINDER_SETTINGS = {
    enabled: true,
    intervals: {
        firstReminder: 4,
        secondReminder: 8,
...
function useComplaintReminderSettings() {
    _s1();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [settings, setSettingsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(DEFAULT_COMPLAINT_REMINDER_SETTINGS);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const saveTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastSavedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('');
    // Load from database
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useComplaintReminderSettings.useEffect": ()=>{
            const loadSettings = {
                "useComplaintReminderSettings.useEffect.loadSettings": async ()=>{
                    try {
                        if (user?.systemId) {
                            const res = await fetch(`${API_BASE}?userId=${user.systemId}&key=${encodeURIComponent(COMPLAINT_REMINDER_SETTINGS_KEY)}`);
                            if (res.ok) {
                                const data = await res.json();
                                if (data && data.value) {
                                    setSettingsState({
                                        ...DEFAULT_COMPLAINT_REMINDER_SETTINGS,
                                        ...data.value
                                    });
                                    lastSavedRef.current = JSON.stringify(data.value);
                                }
            ...
            }["useComplaintReminderSettings.useEffect.loadSettings"];
            loadSettings();
        }
    }["useComplaintReminderSettings.useEffect"], [
        user?.systemId
    ...
    const setSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useComplaintReminderSettings.useCallback[setSettings]": (newSettings)=>{
            ...
            if (user?.systemId) {
                ...
                saveTimeoutRef.current = setTimeout({
                    "useComplaintReminderSettings.useCallback[setSettings]": ()=>{
                        lastSavedRef.current = newValueStr;
                        fetch(API_BASE, {
                            method: 'POST',
                            headers: {
                            ...
                            "useComplaintReminderSettings.useCallback[setSettings]": (error)=>{
                                console.error('Error saving complaint reminder settings:', error);
                            }
                        }["useComplaintReminderSettings.useCallback[setSettings]"]);
                    }
                }["useComplaintReminderSettings.useCallback[setSettings]"], SAVE_DEBOUNCE_DELAY);
            }
        }
    }["useComplaintReminderSettings.useCallback[setSettings]"], [
        user?.systemId
...
_s1(useComplaintReminderSettings, "EKOSVmv7RPISFiDqwJ8PkfDI8aU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_7baf0376._.js.map