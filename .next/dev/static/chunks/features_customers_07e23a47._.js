...
async function loadAckMapFromAPI() {
    try {
        const response = await fetch(`/api/user-preferences?category=${PREFERENCE_CATEGORY}&key=${__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_ACKNOWLEDGEMENTS_KEY"]}`);
        if (response.ok) {
    ...
    try {
        await fetch('/api/user-preferences', {
            ...
            body: JSON.stringify({
                ...
                key: __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_ACKNOWLEDGEMENTS_KEY"],
                value: map
            })
        });
    } catch (error) {
...
async function loadIndexFromAPI() {
    try {
        const response = await fetch(`/api/user-preferences?category=${PREFERENCE_CATEGORY}&key=${__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_EVALUATION_KEY"]}`);
        if (response.ok) {
            const data = await response.json();
...
async function loadLastRunFromAPI() {
    try {
        const response = await fetch(`/api/user-preferences?category=${PREFERENCE_CATEGORY}&key=${__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_LAST_RUN_KEY"]}`);
        if (response.ok) {
            const data = await response.json();
        ...
        try {
            await Promise.all([
                fetch('/api/user-preferences', {
                    ...
                    body: JSON.stringify({
                        category: PREFERENCE_CATEGORY,
                        key: __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_EVALUATION_KEY"],
                        value: index
                    })
                }),
                fetch('/api/user-preferences', {
                    ...
                    body: JSON.stringify({
                        category: PREFERENCE_CATEGORY,
                        key: __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLA_LAST_RUN_KEY"],
                        value: timestamp
                    })
                })
            ]);
    ...
    return {
        ...
        async loadCachedIndex () {
            ...
            if (cachedIndex) {
                set({
                    index: cachedIndex,
                    summary: (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$sla$2f$evaluator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["summarizeIndex"])(cachedIndex),
...
_s(useComputedCustomerDebt, "eDl7lPDzlGMcctMpPWUXvGVyZk8=", false, function() {
    return [
...
_s1(useAllCustomersComputedDebt, "eDl7lPDzlGMcctMpPWUXvGVyZk8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$hooks$2f$use$2d$all$2d$orders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useAllOrders"],
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$receipts$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReceiptStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$payments$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePaymentStore"]
...
_s2(useCustomersWithComputedDebt, "eDl7lPDzlGMcctMpPWUXvGVyZk8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$hooks$2f$use$2d$all$2d$orders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useAllOrders"],
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$receipts$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReceiptStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$payments$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePaymentStore"]
...
//# sourceMappingURL=features_customers_07e23a47._.js.map