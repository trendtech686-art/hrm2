...
"[project]/features/settings/provinces/ward-district-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const WARD_DISTRICT_DATA = rawData.map(_c = (item)=>({
        ...item,
        provinceId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$id$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asBusinessId"])(typeof item.provinceId === 'number' ? item.provinceId.toString().padStart(2, '0') : item.provinceId),
        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seed$2d$audit$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildSeedAuditFields"])({
            createdAt: WARD_DISTRICT_AUDIT_DATE
        })
    }));
_c1 = WARD_DISTRICT_DATA;
const STATISTICS = {
    totalWards: 3321,
    totalDistricts: 696,
    totalProvinces: 34,
...
var _c, _c1;
__turbopack_context__.k.register(_c, "WARD_DISTRICT_DATA$rawData.map");
__turbopack_context__.k.register(_c1, "WARD_DISTRICT_DATA");
...
//# sourceMappingURL=features_settings_provinces_ward-district-data_ts_2aa5bffa._.js.map