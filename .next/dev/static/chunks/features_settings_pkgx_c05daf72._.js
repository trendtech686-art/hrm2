...
"[project]/features/settings/pkgx/hooks/use-product-mapping-validation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useProductMappingValidation(options) {
    ...
    // Create validation context
    const context = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "useProductMappingValidation.useMemo[context]": ()=>({
                hrmProducts,
                pkgxProducts,
                editingProductId
            })
    ...
    const updateSuggestions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[updateSuggestions]": (pkgxProduct)=>{
            const newSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$validation$2f$product$2d$mapping$2d$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestMatchingProducts"])({
                goods_name: pkgxProduct.goods_name,
                goods_sn: pkgxProduct.goods_sn
            }, hrmProducts);
            setSuggestions(newSuggestions);
        }
    }["useProductMappingValidation.useCallback[updateSuggestions]"], [
        hrmProducts
    ]);
    // Sync validation
    const validate = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[validate]": (input)=>{
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$validation$2f$product$2d$mapping$2d$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateProductMapping"])(input, context);
            setValidationResult(result);
            return result;
        }
    }["useProductMappingValidation.useCallback[validate]"], [
        context
    ]);
    // Async validation with debounce
    const validateAsync = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[validateAsync]": async (input)=>{
            return new Promise({
                "useProductMappingValidation.useCallback[validateAsync]": (resolve)=>{
                    setIsValidating(true);
                    if (debounceTimerRef.current) {
                        clearTimeout(debounceTimerRef.current);
                    }
                    debounceTimerRef.current = setTimeout({
                        "useProductMappingValidation.useCallback[validateAsync]": ()=>{
                            const result = validate(input);
                            setIsValidating(false);
                            resolve(result);
                        }
                    }["useProductMappingValidation.useCallback[validateAsync]"], debounceMs);
                }
            }["useProductMappingValidation.useCallback[validateAsync]"]);
        }
    }["useProductMappingValidation.useCallback[validateAsync]"], [
    ...
    // Clear validation
    const clearValidation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[clearValidation]": ()=>{
            setValidationResult(null);
            setSuggestions([]);
            if (debounceTimerRef.current) {
                clearTimeout(debounceTimerRef.current);
    ...
    // Cleanup on unmount
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useProductMappingValidation.useEffect": ()=>{
            return ({
                "useProductMappingValidation.useEffect": ()=>{
                    if (debounceTimerRef.current) {
                        clearTimeout(debounceTimerRef.current);
    ...
    const hasWarnings = validationResult ? validationResult.warnings.length > 0 : false;
    const getFieldError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[getFieldError]": (field)=>{
            if (!validationResult) return undefined;
            const error = validationResult.errors.find({
                "useProductMappingValidation.useCallback[getFieldError].error": (e)=>e.field === field
            }["useProductMappingValidation.useCallback[getFieldError].error"]);
            return error?.message;
        }
    }["useProductMappingValidation.useCallback[getFieldError]"], [
        validationResult
    ]);
    const getFieldWarning = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useProductMappingValidation.useCallback[getFieldWarning]": (field)=>{
            if (!validationResult) return undefined;
            const warning = validationResult.warnings.find({
                "useProductMappingValidation.useCallback[getFieldWarning].warning": (w)=>w.field === field
            }["useProductMappingValidation.useCallback[getFieldWarning].warning"]);
            return warning?.message;
        }
    }["useProductMappingValidation.useCallback[getFieldWarning]"], [
        validationResult
    ]);
    return {
        validationResult,
...
_s(useProductMappingValidation, "pniuDspNOkX2hGvp/b3CYRPT2yM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/features/settings/pkgx/pkgx-settings-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$general$2d$config$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/general-config-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$category$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/category-mapping-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$brand$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/brand-mapping-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$price$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/price-mapping-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$product$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/product-mapping-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$sync$2d$settings$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/sync-settings-tab.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$log$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/settings/pkgx/components/log-tab.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$settings$2f$SettingsVerticalTabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SettingsVerticalTabs"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "general",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$general$2d$config$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GeneralConfigTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 44,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "category-mapping",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$category$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CategoryMappingTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 48,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "brand-mapping",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$brand$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrandMappingTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 52,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "price-mapping",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$price$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PriceMappingTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 56,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "product-mapping",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$product$2d$mapping$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductMappingTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 60,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "sync",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$sync$2d$settings$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SyncSettingsTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 64,
                    columnNumber: 9
                }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                value: "logs",
                className: "mt-0",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$pkgx$2f$components$2f$log$2d$tab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogTab"], {}, void 0, false, {
                    fileName: "[project]/features/settings/pkgx/pkgx-settings-page.tsx",
                    lineNumber: 68,
                    columnNumber: 9
                }, this)
...
_s(PkgxSettingsPage, "BdxCVYbtMYLg4pmg/QhrHc4Z9/E=", false, function() {
    return [
...
_c = PkgxSettingsPage;
var _c;
__turbopack_context__.k.register(_c, "PkgxSettingsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/features/settings/pkgx/pkgx-settings-page.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/features/settings/pkgx/pkgx-settings-page.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=features_settings_pkgx_c05daf72._.js.map