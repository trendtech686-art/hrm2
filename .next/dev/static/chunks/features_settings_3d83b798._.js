...
"[project]/features/settings/receipt-types/hooks/use-all-receipt-types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function useAllReceiptTypes() {
    _s();
    const { data, ...rest } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$receipt$2d$types$2f$hooks$2f$use$2d$receipt$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReceiptTypes"])({});
    return {
        data: data?.data || [],
        ...rest
    };
}
_s(useAllReceiptTypes, "5tnFyQYAQtr/JFJh4/SC11dcJvo=", false, function() {
    return [
...
//# sourceMappingURL=features_settings_3d83b798._.js.map