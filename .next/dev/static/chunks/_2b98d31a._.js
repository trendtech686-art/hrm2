...
"[project]/hooks/use-public-tracking-settings.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useWarrantyTrackingSettings() {
    _s();
    const [settings, setSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(warrantyTrackingCache || DEFAULT_TRACKING_SETTINGS);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(!warrantyTrackingCache);
    const [isSaving, setIsSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Load from API on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useWarrantyTrackingSettings.useEffect": ()=>{
            if (warrantyTrackingCache) {
                setSettings(warrantyTrackingCache);
                setIsLoading(false);
                return;
            }
            loadFromAPI(WARRANTY_KEY).then({
                "useWarrantyTrackingSettings.useEffect": (loaded)=>{
    ...
    const debouncedSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$debounce$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "useWarrantyTrackingSettings.useCallback[debouncedSave]": async (newSettings)=>{
            setIsSaving(true);
            await saveToAPI(WARRANTY_KEY, newSettings);
            setIsSaving(false);
        }
    }["useWarrantyTrackingSettings.useCallback[debouncedSave]"], 500), []);
    const updateSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useWarrantyTrackingSettings.useCallback[updateSettings]": (newSettings)=>{
            warrantyTrackingCache = newSettings;
            setSettings(newSettings);
            debouncedSave(newSettings);
        }
    }["useWarrantyTrackingSettings.useCallback[updateSettings]"], [
        debouncedSave
    ]);
    const updateField = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useWarrantyTrackingSettings.useCallback[updateField]": (key, value)=>{
            const newSettings = {
                ...settings,
                [key]: value
            };
    ...
    }["useWarrantyTrackingSettings.useCallback[updateField]"], [
        settings,
        updateSettings
    ]);
    return {
...
_s(useWarrantyTrackingSettings, "3njDLjvk+v4TKrEi9P7/g8mwPSE=");
function useComplaintsTrackingSettings() {
    _s1();
    const [settings, setSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(complaintsTrackingCache || DEFAULT_TRACKING_SETTINGS);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(!complaintsTrackingCache);
    const [isSaving, setIsSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Load from API on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useComplaintsTrackingSettings.useEffect": ()=>{
            if (complaintsTrackingCache) {
                setSettings(complaintsTrackingCache);
                setIsLoading(false);
                return;
            }
            loadFromAPI(COMPLAINTS_KEY).then({
                "useComplaintsTrackingSettings.useEffect": (loaded)=>{
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    const debouncedSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$debounce$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "useComplaintsTrackingSettings.useCallback[debouncedSave]": async (newSettings)=>{
            setIsSaving(true);
            await saveToAPI(COMPLAINTS_KEY, newSettings);
            setIsSaving(false);
        }
    }["useComplaintsTrackingSettings.useCallback[debouncedSave]"], 500), []);
    const updateSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useComplaintsTrackingSettings.useCallback[updateSettings]": (newSettings)=>{
            complaintsTrackingCache = newSettings;
            setSettings(newSettings);
            debouncedSave(newSettings);
        }
    }["useComplaintsTrackingSettings.useCallback[updateSettings]"], [
        debouncedSave
    ]);
    const updateField = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useComplaintsTrackingSettings.useCallback[updateField]": (key, value)=>{
            const newSettings = {
                ...settings,
                [key]: value
            };
    ...
    }["useComplaintsTrackingSettings.useCallback[updateField]"], [
        settings,
        updateSettings
    ]);
    return {
...
_s1(useComplaintsTrackingSettings, "hztVLVyPCWWj6sNqlIhRaqMkhiM=");
...
//# sourceMappingURL=_2b98d31a._.js.map