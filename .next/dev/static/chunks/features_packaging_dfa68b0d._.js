...
"[project]/features/packaging/columns.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getColumns = (onConfirm, onCancel, onPrint)=>[
        ...
        },
        {
            ...
            header: 'Ngày XN',
            cell: ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.confirmDate),
            meta: {
        ...
        },
        {
            ...
            header: 'Ngày hủy',
            cell: ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.cancelDate),
            meta: {
...
"[project]/features/packaging/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$packaging$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/packaging/columns.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$packaging$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/import-export/configs/packaging.config.ts [app-client] (ecmascript)");
...
_s(CancelDialog, "kStncIrEF7x+SLd1Z8DfHbHv+LA=");
_c = CancelDialog;
function PackagingPage() {
    _s1();
    const { data: allOrders, confirmPackaging, cancelPackagingRequest } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$orders$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderStore"])();
    const { data: branches, findById: findBranchById } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$settings$2f$branches$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBranchStore"])();
    const { findById: findCustomerById } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$customers$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerStore"])();
    ...
    const [cancelDialogState, setCancelDialogState] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](null);
    ...
    const [columnVisibility, setColumnVisibility] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
        "PackagingPage.useState": ()=>{
            // Initialize with all columns visible
            const cols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$packaging$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumns"])({
                "PackagingPage.useState.cols": ()=>{}
            }["PackagingPage.useState.cols"], {
                "PackagingPage.useState.cols": ()=>{}
            }["PackagingPage.useState.cols"], {
                "PackagingPage.useState.cols": ()=>{}
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "PackagingPage.useEffect": ()=>{
            const timer = setTimeout({
                "PackagingPage.useEffect.timer": ()=>setDebouncedGlobalFilter(globalFilter)
            }["PackagingPage.useEffect.timer"], 300);
            return ({
                "PackagingPage.useEffect": ()=>clearTimeout(timer)
            })["PackagingPage.useEffect"];
        }
    }["PackagingPage.useEffect"], [
        globalFilter
    ]);
    const packagingSlips = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[packagingSlips]": ()=>{
            const slips = [];
            allOrders.forEach({
                "PackagingPage.useMemo[packagingSlips]": (order)=>{
                    order.packagings.forEach({
                        "PackagingPage.useMemo[packagingSlips]": (pkg)=>{
                            slips.push({
    ...
    const handleConfirm = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handleConfirm]": (orderSystemId, packagingSystemId)=>{
            confirmPackaging(orderSystemId, packagingSystemId, currentUserSystemId);
        }
    }["PackagingPage.useCallback[handleConfirm]"], [
        confirmPackaging,
        currentUserSystemId
    ]);
    const handleCancelRequest = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handleCancelRequest]": (orderSystemId, packagingSystemId)=>{
            setCancelDialogState({
                orderSystemId,
                packagingSystemId
            });
        }
    }["PackagingPage.useCallback[handleCancelRequest]"], []);
    ...
    const handleBulkPrint = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handleBulkPrint]": (rows)=>{
            setItemsToPrint(rows);
            setPrintDialogOpen(true);
        }
    }["PackagingPage.useCallback[handleBulkPrint]"], []);
    ...
    const handlePrintConfirm = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handlePrintConfirm]": (options)=>{
            ...
            itemsToPrint.forEach({
                "PackagingPage.useCallback[handlePrintConfirm]": (pkg)=>{
                    // Find the order for this packaging
                    let targetOrder = null;
                    let targetPkg = null;
                    for (const order of allOrders){
                        const foundPkg = order.packagings.find({
                            "PackagingPage.useCallback[handlePrintConfirm].foundPkg": (p)=>p.systemId === pkg.systemId
                        }["PackagingPage.useCallback[handlePrintConfirm].foundPkg"]);
                        if (foundPkg) {
                            targetOrder = order;
                            targetPkg = foundPkg;
                            break;
                    ...
                    const storeSettings = branch ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$order$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createStoreSettings"])(branch) : {
                    ...
                    const packingData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$print$2f$order$2d$print$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertToPackingForPrint"])(targetOrder, targetPkg, {
                        customer
                    });
            ...
            }["PackagingPage.useCallback[handlePrintConfirm]"]);
            if (printOptionsList.length > 0) {
                printMultiple('packing', printOptionsList);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Đang in ${printOptionsList.length} phiếu đóng gói`);
            }
    ...
    const handlePrintPackaging = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handlePrintPackaging]": (packagingIds)=>{
            packagingIds.forEach({
                "PackagingPage.useCallback[handlePrintPackaging]": (pkgId)=>{
                    // Find the packaging slip and the order
                    let targetOrder = null;
                    let targetPkg = null;
                    for (const order of allOrders){
                        const pkg = order.packagings.find({
                            "PackagingPage.useCallback[handlePrintPackaging].pkg": (p)=>p.systemId === pkgId
                        }["PackagingPage.useCallback[handlePrintPackaging].pkg"]);
                        if (pkg) {
                            targetOrder = order;
                            targetPkg = pkg;
                            break;
            ...
            }["PackagingPage.useCallback[handlePrintPackaging]"]);
        }
    }["PackagingPage.useCallback[handlePrintPackaging]"], [
        allOrders,
        findCustomerById,
    ...
    const handleBulkCancelPackaging = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handleBulkCancelPackaging]": (packagingIds)=>{
            console.log('Hủy Phiếu Đóng Gói:', packagingIds);
        // TODO: Implement bulk cancel logic
        }
    }["PackagingPage.useCallback[handleBulkCancelPackaging]"], []);
    const handlePrintSinglePackaging = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "PackagingPage.useCallback[handlePrintSinglePackaging]": (packagingId)=>{
            handlePrintPackaging([
                packagingId
            ]);
        }
    }["PackagingPage.useCallback[handlePrintSinglePackaging]"], [
        handlePrintPackaging
    ]);
    const columns = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[columns]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$packaging$2f$columns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumns"])(handleConfirm, handleCancelRequest, handlePrintSinglePackaging)
    }["PackagingPage.useMemo[columns]"], [
        handleConfirm,
        handleCancelRequest,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "PackagingPage.useEffect": ()=>{
            setColumnOrder(columns.map({
                "PackagingPage.useEffect": (c)=>c.id
            }["PackagingPage.useEffect"]).filter(Boolean));
        }
    }["PackagingPage.useEffect"], [
        columns
    ]);
    const fuseInstance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[fuseInstance]": ()=>{
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fuse$2e$js$2f$dist$2f$fuse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](packagingSlips, {
                keys: [
                    'id',
                    'orderId',
                    'customerName',
    ...
    const filteredData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[filteredData]": ()=>{
            let data = packagingSlips;
            if (branchFilter !== 'all') data = data.filter({
                "PackagingPage.useMemo[filteredData]": (s)=>s.branchName === branches.find({
                        "PackagingPage.useMemo[filteredData]": (b)=>b.systemId === branchFilter
                    }["PackagingPage.useMemo[filteredData]"])?.name
            }["PackagingPage.useMemo[filteredData]"]);
            if (statusFilter !== 'all') data = data.filter({
                "PackagingPage.useMemo[filteredData]": (s)=>s.status === statusFilter
            }["PackagingPage.useMemo[filteredData]"]);
            if (debouncedGlobalFilter && debouncedGlobalFilter.trim()) {
                ...
                data = fuseInstance.search(debouncedGlobalFilter.trim()).map({
                    "PackagingPage.useMemo[filteredData]": (r)=>r.item
                }["PackagingPage.useMemo[filteredData]"]);
            }
            return data;
        }
    ...
    const sortedData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[sortedData]": ()=>{
            const sorted = [
                ...filteredData
            ];
            if (sorting.id) {
                sorted.sort({
                    "PackagingPage.useMemo[sortedData]": (a, b)=>{
    ...
    const paginatedData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[paginatedData]": ()=>{
    ...
    const allSelectedRows = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[allSelectedRows]": ()=>packagingSlips.filter({
                "PackagingPage.useMemo[allSelectedRows]": (p)=>rowSelection[p.systemId]
            }["PackagingPage.useMemo[allSelectedRows]"])
    }["PackagingPage.useMemo[allSelectedRows]"], [
        packagingSlips,
        rowSelection
    ]);
    ...
    const bulkActions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "PackagingPage.useMemo[bulkActions]": ()=>[
                {
                    ...
                    onSelect: {
                        "PackagingPage.useMemo[bulkActions]": (rows)=>handleBulkPrint(rows)
                    }["PackagingPage.useMemo[bulkActions]"]
                }
            ]
    }["PackagingPage.useMemo[bulkActions]"], [
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "PackagingPage.useEffect": ()=>{
            if (!isMobile) return;
            const handleScroll = {
                "PackagingPage.useEffect.handleScroll": ()=>{
                    ...
                    if (scrollTop + clientHeight >= scrollHeight * 0.8 && mobileLoadedCount < sortedData.length) {
                        setMobileLoadedCount({
                            "PackagingPage.useEffect.handleScroll": (prev)=>Math.min(prev + 20, sortedData.length)
                        }["PackagingPage.useEffect.handleScroll"]);
                    }
                }
            }["PackagingPage.useEffect.handleScroll"];
            ...
            return ({
                "PackagingPage.useEffect": ()=>window.removeEventListener('scroll', handleScroll)
            })["PackagingPage.useEffect"];
        }
    }["PackagingPage.useEffect"], [
        isMobile,
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(packaging.requestDate)
                                    }, void 0, false, {
                                        fileName: "[project]/features/packaging/page.tsx",
                                        lineNumber: 393,
                                        columnNumber: 29
                            ...
                            packaging.assignedEmployeeName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center text-xs text-muted-foreground",
                                children: [
        ...
        children: [
            ...
            isMobile ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: sortedData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        sortedData.slice(0, mobileLoadedCount).map((packaging)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MobilePackagingCard, {
                                packaging: packaging
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2d$table$2f$responsive$2d$data$2d$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveDataTable"], {
                    columns: columns,
                    data: paginatedData,
                    renderMobileCard: (packaging)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MobilePackagingCard, {
                            packaging: packaging
                        }, void 0, false, {
                            fileName: "[project]/features/packaging/page.tsx",
                            lineNumber: 463,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CancelDialog, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$generic$2d$export$2d$dialog$2d$v2$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericExportDialogV2"], {
                ...
                config: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$import$2d$export$2f$configs$2f$packaging$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["packagingConfig"],
...
_s1(PackagingPage, "XB8ShcfDl6tylHqgkOOSoFH5Ick=", false, function() {
    return [
...
_c1 = PackagingPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "CancelDialog");
__turbopack_context__.k.register(_c1, "PackagingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=features_packaging_dfa68b0d._.js.map